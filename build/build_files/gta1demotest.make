...
RESCOMP = windres
INCLUDES += -I../../src -I../../include -I../external/raylib-master/src
FORCE_INCLUDE +=
...
TARGETDIR = ../../bin/Debug
TARGET = $(TARGETDIR)/gta1demotest.exe
OBJDIR = obj/x64/Debug/gta1demotest
...
TARGETDIR = ../../bin/Debug
TARGET = $(TARGETDIR)/gta1demotest.exe
OBJDIR = obj/x86/Debug/gta1demotest
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGETDIR = ../../bin/Debug
TARGET = $(TARGETDIR)/gta1demotest.exe
OBJDIR = obj/ARM64/Debug/gta1demotest
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGET = $(TARGETDIR)/gta1demotest.exe
OBJDIR = obj/x64/Release/gta1demotest
...
TARGETDIR = ../../bin/Release
TARGET = $(TARGETDIR)/gta1demotest.exe
OBJDIR = obj/x86/Release/gta1demotest
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGETDIR = ../../bin/Release
TARGET = $(TARGETDIR)/gta1demotest.exe
OBJDIR = obj/ARM64/Release/gta1demotest
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
GENERATED += $(OBJDIR)/Buildinstance.o
GENERATED += $(OBJDIR)/Data.o
GENERATED += $(OBJDIR)/PlayerInstance.o
GENERATED += $(OBJDIR)/Render.o
GENERATED += $(OBJDIR)/RenderDbg.o
GENERATED += $(OBJDIR)/main.o
OBJECTS += $(OBJDIR)/Buildinstance.o
OBJECTS += $(OBJDIR)/Data.o
OBJECTS += $(OBJDIR)/PlayerInstance.o
OBJECTS += $(OBJDIR)/Render.o
OBJECTS += $(OBJDIR)/RenderDbg.o
...
$(OBJDIR)/Buildinstance.o: ../../src/Data/BuildInstance/Buildinstance.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Data.o: ../../src/Data/Data.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/PlayerInstance.o: ../../src/Data/PlayerInstance/PlayerInstance.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/RenderDbg.o: ../../src/Renderer/Debug/RenderDbg.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Render.o: ../../src/Renderer/Render.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
